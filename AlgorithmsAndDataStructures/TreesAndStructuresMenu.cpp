...
TreesAndStructuresMenu::TreesAndStructuresMenuResult TreesAndStructuresMenu::Show(sf::RenderWindow& renderWindow){
    renderWindow.clear(sf::Color(100,100,5));
    
    //Begin menu item coordinates
    TreesAndStructuresMenuItem beginButton;
    ...
    sf::Text menuText("Trees and Structures Menu", font, 80);
    menuText.setPosition(400, 50);
    menuText.setColor(sf::Color::White);
    
    sf::Text beginText("Teach me Trees!", font, 40);
